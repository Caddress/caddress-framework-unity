...
namespace Pcx
{
    ...
    class PlyImporter : ScriptedImporter
    {
        ...
        static Material GetDefaultMaterial()
        {
            ...
            var path_prj = "Assets/Plugins/Pcx/Editor/Default Point.mat";
            return AssetDatabase.LoadAssetAtPath<Material>(path_upm) ?? AssetDatabase.LoadAssetAtPath<Material>(path_prj);
        }
