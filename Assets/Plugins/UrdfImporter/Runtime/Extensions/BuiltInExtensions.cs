...
namespace Unity.Robotics.UrdfImporter
{
    public static class BuiltInExtensions
    {
        ...
        public static Vector3 Unity2RosRPY(this Vector3 transform)
        {
            Vector3 rpyVector = new Vector3(
                -transform.z * Mathf.Deg2Rad,
                transform.x * Mathf.Deg2Rad,
        ...
        public static Vector3 GetRotationFromUrdfRpy(this Vector3 Rpy)
        {
            return new Vector3(
        ...
        public static Vector2 Ros2UnitySize(this Vector2 vector2)
        {
            return new Vector2(vector2.y, vector2.x);
        }

        public static Vector2 Unity2RosSize(this Vector2 vector2)
        {
            return new Vector2(vector2.y, vector2.x);
        }
